...
class OptimizerAE(object):
    def __init__(self, reconstructions1, reconstructions2,adj,adj2 ,reconstructions3,features,model,global_step,learning_rate, pos_weight, pos_weight2, norm,norm2,se,indices,p,cons_loss):
        ...
        self.cost =FLAGS.a1*(self.cost1+self.cost2)+FLAGS.a2*self.cost3 + FLAGS.a3 * self.cons_loss
        ...
        self.opt_op2 = self.optimizer2.minimize(self.cost_kl,global_step=global_step)
