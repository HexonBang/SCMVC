...
class clustering_metrics:
    ...
    # def plotClusters(self,hidden_emb, true_labels,epoch):
    #     tsne = TSNE(n_components=2)
    #     X_tsne = tsne.fit_transform(hidden_emb)
    #     # Plot figure
    #     fig = plt.figure()
    #     self.plot(X_tsne, fig, ['brown', 'green', 'orange', 'blue', 'red', 'yellow', 'pink', 'purple'], 6, true_labels)
    #     fig.savesvg("a" + str(epoch) + ".svg")
    ...
    def plotClusters(self, hidden_emb, true_labels, epoch):
        ...
        # 保存SVG文件
        fig.savefig("a" + str(epoch) + ".svg", format="svg")
